...
| --- | --- | --- |
| [2.1.7](/releases/v2.1.7) | 2026.08.20 | Multiple workspaces isolated per session, session-level permission modes, task completion notifications, desktop voice input, new models (glm-5.3, qwen3.8-max, gemini-3.7-flash) |
