...
CowAgent は単一の Agent にとどまりません。複数の Agent でチームを構成でき、各メンバーはそれぞれの役割、モデル、Skill、知識を持ち、ワークスペースと記憶は互いに分離されています。独立して作業することも、同じセッションに参加して協働することもできます。チャネルには単一の Agent またはチーム全体をバインドして対外的にサービスを提供でき、デジタル従業員チームを手軽に構築できます。
