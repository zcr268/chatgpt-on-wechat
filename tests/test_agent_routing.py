...
from agent.routing import AgentBindingError, AgentRouter, AgentUnavailableError
...
def test_unavailable_binding_refuses_rather_than_substituting(registry):
    """Falling back to the default agent would answer the user with another
    Agent's persona, memory and workspace, invisibly."""
    router = _router(
        registry,
