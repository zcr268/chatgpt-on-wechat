...
const I18N = {
    zh: {
        ...
        mcp_test_ok: '连接成功', mcp_test_fail: '连接失败', mcp_save_error: '保存失败', mcp_load_failed: '读取 MCP 配置失败',
    ...
    'zh-Hant': {
        ...
        mcp_test_ok: '連線成功', mcp_test_fail: '連線失敗', mcp_save_error: '儲存失敗', mcp_load_failed: '讀取 MCP 設定失敗',
    ...
    en: {
        ...
        mcp_test_ok: 'Connected', mcp_test_fail: 'Connection failed', mcp_save_error: 'Save failed', mcp_load_failed: 'Could not read the MCP config',
