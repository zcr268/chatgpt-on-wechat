...
const I18N = {
    zh: {
        ...
        menu_chat: '对话', menu_agents: '智能体', menu_config: '配置', menu_skills: '能力',
        ...
        skills_title: '能力', skills_desc: '管理 Agent 可以调用的内置工具、MCP 工具和技能', skills_hub_btn: '探索技能广场',
        skills_loading: '加载技能中...', skills_loading_desc: '技能加载后将显示在此处',
        skills_empty: '还没有安装技能', skills_empty_hint: '从技能市场安装，或上传自己的技能',
        tools_section_title: '内置工具', tools_loading: '加载工具中...',
        tools_show_all: '展开全部', tools_collapse: '收起', tools_empty: '暂无内置工具', tools_load_failed: '加载失败',
        skills_section_title: '技能', skill_enable: '启用', skill_disable: '禁用',
        skill_click_enable: '点击启用', skill_click_disable: '点击禁用',
        ...
        mcp_add: '添加 MCP', mcp_add_title: '添加 MCP 工具', mcp_edit: '编辑 MCP 工具',
        mcp_empty: '还没有接入 MCP 工具', mcp_empty_hint: '可以手动填写，也可以直接粘贴 MCP 市场提供的 JSON 配置',
        mcp_test: '测试连接', mcp_testing: '正在连接并获取工具列表...', mcp_save: '保存', mcp_cancel: '取消', mcp_delete: '删除',
        mcp_saved: 'MCP 工具已保存', mcp_saved_tools: '已保存，发现 {n} 个工具', mcp_save_anyway: '仍然保存',
        mcp_check_failed: '连接校验未通过，请检查配置，或选择仍然保存',
        ...
        mcp_tab_form: '表单', mcp_advanced: '高级设置',
        mcp_field_name: '名称', mcp_field_name_ph: '例如 fetch', mcp_field_type: '传输方式', mcp_field_command: '命令',
        ...
        mcp_field_prefix: '工具名前缀', mcp_field_timeout: '超时（秒）', mcp_field_disabled: '暂时停用',
        mcp_transport_stdio_hint: '本地命令', mcp_transport_remote_hint: '远程服务',
        mcp_json_hint: '粘贴 mcpServers 格式的配置，可以一次添加多个',
        mcp_json_invalid: 'JSON 格式有误', mcp_json_empty: '请填写 MCP 配置',
        mcp_json_need_name: '缺少名称，请用 {"mcpServers": {"名称": {...}}} 的格式',
        mcp_json_multi_to_form: '包含多个 MCP 工具，只能在 JSON 模式下保存',
        mcp_json_edit_single: '编辑时只能包含一个 MCP 工具',
        mcp_name_required: '请填写名称', mcp_name_exists: '已存在同名的 MCP 工具：{name}，请改名或编辑已有项',
        mcp_test_ok: '连接成功', mcp_test_fail: '连接失败', mcp_test_tools: '工具列表',
        mcp_test_no_tools: '连接成功，但该服务没有提供工具',
        mcp_test_needs_auth: '需要 OAuth 授权，保存后在对话中按提示完成授权',
        mcp_save_error: '保存失败', mcp_load_failed: '读取 MCP 配置失败',
        mcp_delete_confirm: '确定删除这个 MCP 工具吗？',
        skill_add: '添加技能', skill_add_tab_market: '从市场安装', skill_add_tab_upload: '本地上传',
        skill_source: '来源', skill_source_local: '本地上传',
        skill_value_hub: '技能名称', skill_value_github: '仓库或目录地址', skill_value_clawhub: '技能名称',
        skill_hint_hub: '填写技能广场中的技能名称，可前往浏览：',
        skill_hint_github: '支持仓库地址、子目录地址（/tree/分支/路径）或 owner/repo 简写',
        skill_hint_clawhub: '填写 ClawHub 上的技能名称（不支持插件），可前往浏览：',
        skill_fetch: '获取预览', skill_fetching: '正在获取...',
        skill_upload_drop: '拖拽技能到这里，或', skill_upload_pick_file: '选择文件', skill_upload_pick_folder: '选择文件夹',
        skill_upload_types: '支持 .zip / .tar.gz 压缩包、SKILL.md 或整个技能文件夹，最大 50 MB',
        skill_uploading: '正在读取...', skill_upload_too_large: '文件超过 50 MB',
        skill_preview_title: '确认内容后再安装', skill_preview_found: '发现 {n} 个技能',
        skill_preview_warning: '技能可以包含脚本并由 Agent 执行，请确认来源可信、内容符合预期后再安装。',
        skill_preview_exists: '已安装，将覆盖', skill_preview_files: '{n} 个文件', skill_preview_select_all: '全选',
        skill_preview_show_files: '文件列表', skill_preview_truncated: '内容较长，仅显示前 64 KB',
        skill_preview_no_md: '没有 SKILL.md',
        skill_back_edit: '返回修改', skill_confirm_install_n: '安装 {n} 个技能', skill_installing: '正在安装...',
        skill_installed_title: '安装完成', skill_installed_desc: '已安装 {n} 个技能', skill_done: '完成',
        ...
        reply_cancelled: '已中止', reply_interrupted: '已中断', reply_running: '仍在运行，稍后刷新查看最新进度',
        error_connection_lost: '连接已断开。回复可能仍在生成，稍后刷新页面即可查看。',
    ...
    'zh-Hant': {
        ...
        menu_chat: '對話', menu_agents: '智慧體', menu_config: '設定', menu_skills: '能力',
        ...
        skills_title: '能力', skills_desc: '管理 Agent 可以呼叫的內建工具、MCP 工具和技能', skills_hub_btn: '探索技能廣場',
        skills_loading: '載入技能中...', skills_loading_desc: '技能載入後將顯示在此處',
        skills_empty: '還沒有安裝技能', skills_empty_hint: '從技能市場安裝，或上傳自己的技能',
        tools_section_title: '內建工具', tools_loading: '載入工具中...',
        tools_show_all: '展開全部', tools_collapse: '收起', tools_empty: '暫無內建工具', tools_load_failed: '載入失敗',
        skills_section_title: '技能', skill_enable: '啟用', skill_disable: '禁用',
        skill_click_enable: '點擊啟用', skill_click_disable: '點擊禁用',
        ...
        mcp_section_title: 'MCP 工具',
        mcp_add: '新增 MCP', mcp_add_title: '新增 MCP 工具', mcp_edit: '編輯 MCP 工具',
        mcp_empty: '還沒有接入 MCP 工具', mcp_empty_hint: '可以手動填寫，也可以直接貼上 MCP 市場提供的 JSON 設定',
        mcp_test: '測試連線', mcp_testing: '正在連線並取得工具列表...', mcp_save: '儲存', mcp_cancel: '取消', mcp_delete: '刪除',
        mcp_saved: 'MCP 工具已儲存', mcp_saved_tools: '已儲存，發現 {n} 個工具', mcp_save_anyway: '仍然儲存',
        mcp_check_failed: '連線校驗未通過，請檢查設定，或選擇仍然儲存',
        ...
        mcp_tab_form: '表單', mcp_advanced: '進階設定',
        mcp_field_name: '名稱', mcp_field_name_ph: '例如 fetch', mcp_field_type: '傳輸方式', mcp_field_command: '命令',
        ...
        mcp_field_prefix: '工具名前綴', mcp_field_timeout: '逾時（秒）', mcp_field_disabled: '暫時停用',
        mcp_transport_stdio_hint: '本機命令', mcp_transport_remote_hint: '遠端服務',
        mcp_json_hint: '貼上 mcpServers 格式的設定，可以一次新增多個',
        mcp_json_invalid: 'JSON 格式有誤', mcp_json_empty: '請填寫 MCP 設定',
        mcp_json_need_name: '缺少名稱，請用 {"mcpServers": {"名稱": {...}}} 的格式',
        mcp_json_multi_to_form: '包含多個 MCP 工具，只能在 JSON 模式下儲存',
        mcp_json_edit_single: '編輯時只能包含一個 MCP 工具',
        mcp_name_required: '請填寫名稱', mcp_name_exists: '已存在同名的 MCP 工具：{name}，請改名或編輯既有項目',
        mcp_test_ok: '連線成功', mcp_test_fail: '連線失敗', mcp_test_tools: '工具列表',
        mcp_test_no_tools: '連線成功，但該服務沒有提供工具',
        mcp_test_needs_auth: '需要 OAuth 授權，儲存後在對話中依提示完成授權',
        mcp_save_error: '儲存失敗', mcp_load_failed: '讀取 MCP 設定失敗',
        mcp_delete_confirm: '確定刪除這個 MCP 工具嗎？',
        skill_add: '新增技能', skill_add_tab_market: '從市場安裝', skill_add_tab_upload: '本機上傳',
        skill_source: '來源', skill_source_local: '本機上傳',
        skill_value_hub: '技能名稱', skill_value_github: '儲存庫或目錄位址', skill_value_clawhub: '技能名稱',
        skill_hint_hub: '填寫技能廣場中的技能名稱，可前往瀏覽：',
        skill_hint_github: '支援儲存庫位址、子目錄位址（/tree/分支/路徑）或 owner/repo 簡寫',
        skill_hint_clawhub: '填寫 ClawHub 上的技能名稱（不支援外掛），可前往瀏覽：',
        skill_fetch: '取得預覽', skill_fetching: '正在取得...',
        skill_upload_drop: '拖曳技能到這裡，或', skill_upload_pick_file: '選擇檔案', skill_upload_pick_folder: '選擇資料夾',
        skill_upload_types: '支援 .zip / .tar.gz 壓縮檔、SKILL.md 或整個技能資料夾，最大 50 MB',
        skill_uploading: '正在讀取...', skill_upload_too_large: '檔案超過 50 MB',
        skill_preview_title: '確認內容後再安裝', skill_preview_found: '發現 {n} 個技能',
        skill_preview_warning: '技能可以包含腳本並由 Agent 執行，請確認來源可信、內容符合預期後再安裝。',
        skill_preview_exists: '已安裝，將覆蓋', skill_preview_files: '{n} 個檔案', skill_preview_select_all: '全選',
        skill_preview_show_files: '檔案列表', skill_preview_truncated: '內容較長，僅顯示前 64 KB',
        skill_preview_no_md: '沒有 SKILL.md',
        skill_back_edit: '返回修改', skill_confirm_install_n: '安裝 {n} 個技能', skill_installing: '正在安裝...',
        skill_installed_title: '安裝完成', skill_installed_desc: '已安裝 {n} 個技能', skill_done: '完成',
        ...
        reply_cancelled: '已中止', reply_interrupted: '已中斷', reply_running: '仍在執行，稍後重新整理查看最新進度',
        error_connection_lost: '連線已中斷。回覆可能仍在產生，稍後重新整理頁面即可查看。',
    ...
    en: {
        ...
        menu_chat: 'Chat', menu_agents: 'Agents', menu_config: 'Config', menu_skills: 'Capabilities',
        ...
        skills_title: 'Capabilities', skills_desc: 'Manage the built-in tools, MCP tools, and skills your agent can use', skills_hub_btn: 'Skill Hub',
        skills_loading: 'Loading skills...', skills_loading_desc: 'Skills will be displayed here after loading',
        skills_empty: 'No skills installed yet', skills_empty_hint: 'Install one from a skill market, or upload your own',
        tools_section_title: 'Built-in Tools', tools_loading: 'Loading tools...',
        tools_show_all: 'Show all', tools_collapse: 'Show less', tools_empty: 'No built-in tools', tools_load_failed: 'Failed to load',
        skills_section_title: 'Skills', skill_enable: 'Enable', skill_disable: 'Disable',
        skill_click_enable: 'Click to enable', skill_click_disable: 'Click to disable',
        ...
        mcp_add: 'Add MCP', mcp_add_title: 'Add MCP tool', mcp_edit: 'Edit MCP tool',
        mcp_empty: 'No MCP tools connected yet', mcp_empty_hint: 'Fill in the form, or paste the JSON config an MCP directory gives you',
        mcp_test: 'Test connection', mcp_testing: 'Connecting and listing tools...', mcp_save: 'Save', mcp_cancel: 'Cancel', mcp_delete: 'Delete',
        mcp_saved: 'MCP tool saved', mcp_saved_tools: 'Saved. {n} tool(s) found.', mcp_save_anyway: 'Save anyway',
        mcp_check_failed: 'The connection check failed. Fix the config, or save anyway.',
        ...
        mcp_tab_form: 'Form', mcp_advanced: 'Advanced',
        mcp_field_name: 'Name', mcp_field_name_ph: 'e.g. fetch', mcp_field_type: 'Transport', mcp_field_command: 'Command',
        ...
        mcp_field_prefix: 'Tool name prefix', mcp_field_timeout: 'Timeout (seconds)', mcp_field_disabled: 'Disabled',
        mcp_transport_stdio_hint: 'Local command', mcp_transport_remote_hint: 'Remote server',
        mcp_json_hint: 'Paste a config in the mcpServers format. Several servers can be added at once.',
        mcp_json_invalid: 'Invalid JSON', mcp_json_empty: 'Enter an MCP config',
        mcp_json_need_name: 'Missing a name. Use the {"mcpServers": {"name": {...}}} format.',
        mcp_json_multi_to_form: 'This config has several MCP tools and can only be saved in JSON mode',
        mcp_json_edit_single: 'Only one MCP tool can be edited at a time',
        mcp_name_required: 'Enter a name', mcp_name_exists: 'An MCP tool named {name} already exists. Rename it or edit the existing one.',
        mcp_test_ok: 'Connected', mcp_test_fail: 'Connection failed', mcp_test_tools: 'Tools',
        mcp_test_no_tools: 'Connected, but the server offers no tools',
        mcp_test_needs_auth: 'Needs OAuth authorization. Save it, then follow the prompt in the chat.',
        mcp_save_error: 'Save failed', mcp_load_failed: 'Could not read the MCP config',
        mcp_delete_confirm: 'Delete this MCP tool?',
        skill_add: 'Add skill', skill_add_tab_market: 'From a market', skill_add_tab_upload: 'Upload',
        skill_source: 'Source', skill_source_local: 'Uploaded',
        skill_value_hub: 'Skill name', skill_value_github: 'Repository or folder URL', skill_value_clawhub: 'Skill name',
        skill_hint_hub: 'The skill\'s name on Skill Hub. Browse at',
        skill_hint_github: 'A repository URL, a folder URL (/tree/branch/path), or owner/repo',
        skill_hint_clawhub: 'The skill\'s name on ClawHub (plugins are not supported). Browse at',
        skill_fetch: 'Fetch preview', skill_fetching: 'Fetching...',
        skill_upload_drop: 'Drop a skill here, or', skill_upload_pick_file: 'choose a file', skill_upload_pick_folder: 'a folder',
        skill_upload_types: '.zip / .tar.gz archive, a SKILL.md, or a whole skill folder, up to 50 MB',
        skill_uploading: 'Reading...', skill_upload_too_large: 'Files exceed 50 MB',
        skill_preview_title: 'Review before installing', skill_preview_found: '{n} skill(s) found',
        skill_preview_warning: 'Skills can include scripts the agent will run. Install only from sources you trust, after checking the content.',
        skill_preview_exists: 'Installed, will be replaced', skill_preview_files: '{n} file(s)', skill_preview_select_all: 'Select all',
        skill_preview_show_files: 'Files', skill_preview_truncated: 'Long file: only the first 64 KB is shown',
        skill_preview_no_md: 'No SKILL.md',
        skill_back_edit: 'Back', skill_confirm_install_n: 'Install {n}', skill_installing: 'Installing...',
        skill_installed_title: 'Installed', skill_installed_desc: '{n} skill(s) installed', skill_done: 'Done',
        ...
        reply_cancelled: 'Stopped', reply_interrupted: 'Interrupted', reply_running: 'Still running; refresh later to see the latest progress',
