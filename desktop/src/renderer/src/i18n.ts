const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    skills_title: '能力',
    skills_desc: '管理 Agent 可以调用的内置工具、MCP 工具和技能',
    ...
    tools_show_all: '展开全部',
    tools_collapse: '收起',
    skills_empty: '还没有安装技能',
    skills_empty_hint: '从技能市场安装，或上传自己的技能',
    ...
    mcp_add: '添加 MCP',
    mcp_add_title: '添加 MCP 工具',
    mcp_edit: '编辑 MCP 工具',
    mcp_empty: '还没有接入 MCP 工具',
    mcp_empty_hint: '可以手动填写，也可以直接粘贴 MCP 市场提供的 JSON 配置',
    mcp_test: '测试连接',
    mcp_testing: '正在连接并获取工具列表...',
    mcp_save: '保存',
    mcp_cancel: '取消',
    mcp_delete: '删除',
    mcp_saved: 'MCP 工具已保存',
    mcp_saved_tools: '已保存，发现 {n} 个工具',
    mcp_save_anyway: '仍然保存',
    ...
    mcp_field_disabled: '暂时停用',
    mcp_transport_stdio_hint: '本地命令',
    mcp_transport_remote_hint: '远程服务',
    mcp_json_hint: '粘贴 mcpServers 格式的配置，可以一次添加多个',
    mcp_json_invalid: 'JSON 格式有误',
    mcp_json_empty: '请填写 MCP 配置',
    ...
    mcp_name_required: '请填写名称',
    mcp_name_exists: '已存在同名的 MCP 工具：{name}，请改名或编辑已有项',
    mcp_test_ok: '连接成功',
    mcp_test_fail: '连接失败',
    mcp_test_tools: '工具列表',
    ...
    skill_value_github: '仓库或目录地址',
    skill_value_clawhub: '技能名称',
    ...
    skill_fetch: '获取预览',
    skill_fetching: '正在获取...',
    skill_upload_drop: '拖拽技能到这里，或',
    skill_upload_pick_file: '选择文件',
    skill_upload_pick_folder: '选择文件夹',
    skill_upload_types: '支持 .zip / .tar.gz 压缩包、SKILL.md 或整个技能文件夹，最大 50 MB',
    skill_uploading: '正在读取...',
    skill_upload_too_large: '文件超过 50 MB',
    skill_preview_found: '发现 {n} 个技能',
    skill_preview_warning: '技能可以包含脚本并由 Agent 执行，请确认来源可信、内容符合预期后再安装。',
    skill_preview_exists: '已安装，将覆盖',
    skill_preview_files: '{n} 个文件',
    skill_preview_select_all: '全选',
    skill_preview_show_files: '文件列表',
    skill_preview_truncated: '内容较长，仅显示前 64 KB',
    skill_preview_no_md: '没有 SKILL.md',
    skill_back_edit: '返回修改',
    skill_confirm_install_n: '安装 {n} 个技能',
    skill_installing: '正在安装...',
    skill_installed_title: '安装完成',
    skill_installed_desc: '已安装 {n} 个技能',
    skill_done: '完成',
  ...
  en: {
    ...
    msg_edit: 'Edit',
    msg_delete: 'Delete',
    msg_cancelled: 'Stopped',
    reply_interrupted: 'Interrupted',
    reply_running: 'Still running…',
    ...
    skills_desc: 'Manage the built-in tools, MCP tools, and skills your agent can use',
    ...
    tools_show_all: 'Show all',
    tools_collapse: 'Show less',
    skills_empty: 'No skills installed yet',
    skills_empty_hint: 'Install one from a skill market, or upload your own',
    ...
    mcp_add: 'Add MCP',
    mcp_add_title: 'Add MCP tool',
    mcp_edit: 'Edit MCP tool',
    mcp_empty: 'No MCP tools connected yet',
    mcp_empty_hint: 'Fill in the form, or paste the JSON config an MCP directory gives you',
    mcp_test: 'Test connection',
    mcp_testing: 'Connecting and listing tools...',
    mcp_save: 'Save',
    mcp_cancel: 'Cancel',
    mcp_delete: 'Delete',
    mcp_saved: 'MCP tool saved',
    mcp_saved_tools: 'Saved. {n} tool(s) found.',
    mcp_save_anyway: 'Save anyway',
    ...
    mcp_tab_form: 'Form',
    mcp_advanced: 'Advanced',
    mcp_field_name: 'Name',
    mcp_field_name_ph: 'e.g. fetch',
    ...
    mcp_field_disabled: 'Disabled',
    mcp_transport_stdio_hint: 'Local command',
    mcp_transport_remote_hint: 'Remote server',
    mcp_json_hint: 'Paste a config in the mcpServers format. Several servers can be added at once.',
    mcp_json_invalid: 'Invalid JSON',
    mcp_json_empty: 'Enter an MCP config',
    ...
    mcp_name_required: 'Enter a name',
    mcp_name_exists: 'An MCP tool named {name} already exists. Rename it or edit the existing one.',
    mcp_test_ok: 'Connected',
    mcp_test_fail: 'Connection failed',
    mcp_test_tools: 'Tools',
    ...
    mcp_load_failed: 'Could not read the MCP config',
    ...
    skill_value_github: 'Repository or folder URL',
    skill_value_clawhub: 'Skill name',
    ...
    skill_fetch: 'Fetch preview',
    skill_fetching: 'Fetching...',
    skill_upload_drop: 'Drop a skill here, or',
    skill_upload_pick_file: 'choose a file',
    skill_upload_pick_folder: 'a folder',
    skill_upload_types: '.zip / .tar.gz archive, a SKILL.md, or a whole skill folder, up to 50 MB',
    skill_uploading: 'Reading...',
    skill_upload_too_large: 'Files exceed 50 MB',
    skill_preview_found: '{n} skill(s) found',
    ...
    skill_preview_exists: 'Installed, will be replaced',
    skill_preview_files: '{n} file(s)',
    skill_preview_select_all: 'Select all',
    skill_preview_show_files: 'Files',
    skill_preview_truncated: 'Long file: only the first 64 KB is shown',
    skill_preview_no_md: 'No SKILL.md',
    skill_back_edit: 'Back',
    skill_confirm_install_n: 'Install {n}',
    skill_installing: 'Installing...',
    skill_installed_title: 'Installed',
    skill_installed_desc: '{n} skill(s) installed',
    skill_done: 'Done',
