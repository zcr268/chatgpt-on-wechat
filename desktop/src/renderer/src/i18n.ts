const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    config_task_notify_hint: '任务完成或失败时发送系统通知，点击可跳转会话',
  ...
  en: {
    ...
    config_task_notify_hint: 'Show a system notification when a task finishes or fails; click to open the session',
